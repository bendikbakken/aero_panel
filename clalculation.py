...
"""
This is only used to calculate integrals and stuff. It's super messy, wildly inconsistent and I'm deeply ashamed of it:)
However, it works and I don't want to mess with it. 
"""
...
def A1_1(th):
    return 2 / pi * (0.25 * 0.5 * (th + 0.5 * sin(2 * th)) - 0.05 * sin(th))
def A1_2(th):
    return 2 / pi * (0.111 * 0.5 * (th + 0.5 * sin(2 * th)) - 0.0222 * sin(th))
